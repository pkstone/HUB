...
audio_file = 'SYM_Memory_dump.wav'
out_file = 'SYM_Mem.bin'

sign = lambda word: (1, -1)[word < 0]

def decode_wav(infilename, outfilename, binary):
    ...
    row_count = 0
    out_bytes = []
    byte_count = 0xE000    #47344
    
    with open(infilename, mode="rb") as f:
        word = 0
...
decode_wav(audio_file, out_file, True)
