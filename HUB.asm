...
;
; Source recreated from ROM machine code of original SYM HUB
...
CHECKT      LDA V1_IFR			;Is this a V1 timer interrupt?
            ...
            BNE BRCB76
            INC HTIMER+1
BRCB76      JSR SCAN_D			;(update some counter?) and display it
            JMP GOJUMP
...
SCAN_D      INC HTDSP4			;Display Hub timer in stopwatch format
            LDA HTDSP4
            CMP #60
            BCC BRCC46
            LDA #0
